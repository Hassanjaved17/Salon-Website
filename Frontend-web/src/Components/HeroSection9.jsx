  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="w-16 h-16 rounded-full border border-black mx-auto flex items-center justify-center bg-[#FEF9C2] shadow-lg text-2xl text-black mb-6"
      >
        <FaEnvelope />
      </motion.div>
    ...
    <div className="bg-yellow-100 py-20 px-4 md:px-10">
      ...
      <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
        ...
        <motion.div
          ...
          animate={isLeftInView ? { opacity: 1, x: 0 } : null}
        ...
        <motion.div
          ref={rightRef}
          initial={{ opacity: 0, x: 100 }}
          animate={isRightInView ? { opacity: 1, x: 0 } : null}
          transition={{ duration: 0.7, ease: 'easeOut' }}
          className="relative w-full md:w-[50%] min-h-[400px] sm:min-h-[450px] md:min-h-[500px] bg-cover bg-center rounded-md overflow-hidden shadow-lg"
